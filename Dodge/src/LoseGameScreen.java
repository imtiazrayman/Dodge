...
public class LoseGameScreen {
	...
	public  void render(Graphics g) { // this class just makes our menu page and then renders them on the screen. 
		...
		g.drawString("YOU DIED", Game.WIDTH/2 - 200, 100);
		...
		g.drawString("YOU DIDNT MAKE IT IN " + status.statusUpdater() + " MODE.", 10, playButton.y + 30); //  placing the text within the rectangles
		//g2d.draw(playButton);
